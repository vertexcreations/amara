...
def restore_backup(filename):
    ...
    try:
        ...
        # Remove safety if successful? Keep it implies manual cleanup. Let's keep it simple.
...
def upload_backup():
    ...
    if file and file.filename.endswith('.db'):
        backup_dir = get_backup_dir()
        # Sanitize name or just use it? safer to timestamp if conflict?
        # Let's keep original name but ensure .db
